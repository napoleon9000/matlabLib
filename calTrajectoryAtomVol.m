function [solidVol, totVol, Vsurface] = calTrajectoryAtomVol(filename,readRange,meshSize,atomSize)
...
%     end
    ...
    volFrame = volFrame + 1;
    %ftell(FID)
    [solidVol(volFrame-1), Vsurface(volFrame-1) ] = calAtomVolFast(Coordinates(:,:,frame), cellLength(:,frame), atomElement(:,frame), meshSize, atomSize);
