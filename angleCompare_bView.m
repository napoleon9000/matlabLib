...
CO3Coordinate1=CorrelateCO3(coordinate1,ONumber,CaNumber,CNumber,a1,b1,c1,cutOff);  %Correlate the C and O atoms in CO3
...
quiver3([coordinate1(atom1+1:atom1+atom2,1);1],[coordinate1(atom1+1:atom1+atom2,2);1],[coordinate1(atom1+1:atom1+atom2,3);1],...
        [dcoordinate(atom1+1:atom1+atom2,1);0],[dcoordinate(atom1+1:atom1+atom2,2);.1],[dcoordinate(atom1+1:atom1+atom2,3);0],0.6,'r','linewidth',1);
xlabel('[1 1 0]');
ylabel('[1 -1 0]');
zlabel('[0 0 -1]');
...
quiver3([coordinate1(atom1+atom2+1:atom1+atom2+atom3,1);2],[coordinate1(atom1+atom2+1:atom1+atom2+atom3,2);2],[coordinate1(atom1+atom2+1:atom1+atom2+atom3,3);2],...
        [dcoordinate(atom1+atom2+1:atom1+atom2+atom3,1);0],[dcoordinate(atom1+atom2+1:atom1+atom2+atom3,2);.1],[dcoordinate(atom1+atom2+1:atom1+atom2+atom3,3);0],0.4,'k','linewidth',1);
% Create label
